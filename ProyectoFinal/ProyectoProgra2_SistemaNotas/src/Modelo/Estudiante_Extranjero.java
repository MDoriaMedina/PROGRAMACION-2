...
public class Estudiante_Extranjero extends Estudiante {
	
	public String pasaporte;
	public String idioma;

	public Estudiante_Extranjero(String apellidoPaterno, String apellidoMaterno, String nombres, String telefono, int birthYear, int birthMonth, int birthDay, String residencia, String nacionalidad, String pasaporte, String idioma) {
