...
public class Estudiante_Nacional extends Estudiante{

	public String carnet;
	public String deptoNacimiento;
	
	public Estudiante_Nacional(String apellidoPaterno, String apellidoMaterno, String nombres, String telefono, int birthYear, int birthMonth, int birthDay, String residencia, String nacionalidad, String carnet, String deptoNacimiento) {
