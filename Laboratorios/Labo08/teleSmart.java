...
public class teleSmart extends Television {
      
    public String resolucion;
    public int cantPuertos;

    public teleSmart(double precioBase, String color, char consumoEnergetico, double peso, int pulgadas,String resolucion , int cantPuertos){
